...
BEGIN
    ...
    -- Log the INSERT operation with all new values as JSON
    INSERT INTO transaction_log 
...
BEGIN
    ...
    -- Log the UPDATE operation with old and new values as JSON
    INSERT INTO transaction_log 
    (transaction_id, log_sequence, log_type, table_name, record_id, 
     column_name, old_value, new_value, operation_type, source_node, timestamp)
    VALUES 
...
BEGIN
    ...
    -- Log the DELETE operation with old values
    INSERT INTO transaction_log 
    (transaction_id, log_sequence, log_type, table_name, record_id, 
     column_name, old_value, new_value, operation_type, source_node, timestamp)
    VALUES 
...
SELECT 'Main node triggers created successfully' AS status;
