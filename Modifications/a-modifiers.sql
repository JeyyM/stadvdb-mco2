...
BEGIN
    ...
    -- Insert into local node if this record belongs here (>= 2010)
    IF new_startYear IS NOT NULL AND new_startYear >= 2010 THEN
...
BEGIN
    ...
    ELSEIF new_startYear IS NOT NULL AND new_startYear >= 2010 THEN
